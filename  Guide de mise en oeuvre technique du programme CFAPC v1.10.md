...
[2.1 Diagramme de ciblage du CFAPC [12](#diagramme-de-ciblage-du-cfapc)](#diagramme-de-ciblage-du-cfapc)
...
[2.3.2.1 Soutien du CFAPC lors d’une panne [26](#soutien-du-cfapc-lors-dune-panne)](#soutien-du-cfapc-lors-dune-panne)
...
[Exemple XCSN - Réponse CSN (RFI) [41](#exemple-xcsn---réponse-csn-rfi)](#exemple-xcsn---réponse-csn-rfi)
...
[3.5.1 Exemples de présentation d’un message Cargo-XML [48](#exemples-de-présentation-dun-message-cargo-xml)](#exemples-de-présentation-dun-message-cargo-xml)
...
[7.2 Demande de vérification [64](#demande-de-contrôle)](#demande-de-contrôle)
...
[7.5 Pannes du système [66](#pannes-du-système)](#pannes-du-système)
...
<td>12 juin 2026</td>
<td>1.10</td>
<td>1.4.2 Participants admissibles (autres soumissionnaires de données)</td>
<td>Contexte supplémentaire sur les rôles des différents participants</td>
</tr>
<tr>
<td></td>
<td></td>
<td>2.2.5.1 Éléments de données CFAPC</td>
<td>Exemples supplémentaires de descriptions de fret</td>
</tr>
<tr>
<td></td>
<td></td>
<td>2.3.2.1 B Soutien du CFAPC lors d’une panne</td>
<td>Nouvelle exigence : inclure certaines informations précises lors d’un avis d’une panne prévue</td>
</tr>
</tbody>
</table>
...
Ce guide s’adresse à l’équipe de mise en œuvre ou au technicien chargé de configurer la connexion des données d’autres présentateurs de données au programme CFAPC.
...
D’autres partenaires de la chaîne d’approvisionnement, tels que les transitaires ou les transporteurs aériens qui établissent des lettres de transport ou qui exploitent des vols avant le dernier point de départ pour le Canada (p. ex., les accords de partage de codes) peuvent également participer au CFAPC à titre volontaire, **<u>à la demande d’un transporteur aérien</u>**.

Au moment de leur inscription au CFAPC, les transporteurs aériens doivent identifier leurs fournisseurs de services et transitaires, afin d’autoriser la connexion de leurs partenaires au sein de la chaîne d’approvisionnement au système CFAPC.

**Remarque :** Même si les transporteurs aériens peuvent déléguer certaines exigences, ils sont ultimement responsables de se conformer au *Règlement canadien de 2012 sur la sûreté aérienne*.
...
Le *Règlement modifiant le Règlement canadien de 2012 sur la sûreté aérienne* *(fret aérien)* est entré en vigueur le 1<sup>er</sup> avril 2025. Les transporteurs aériens doivent soumettrent les éléments de données requis au système CFAPC et qu’ils soient prêts à répondre aux demandes de Transports Canada (RFI, RFS, DNL), à défaut de quoi ils sont susceptibles de faire l’objet de sanctions administratives pécuniaires (SAP).
...
Les participants doivent apprendre à connaître les avis qu’ils peuvent s’attendre à recevoir via le programme CFAPC plutôt que par courriel en fonction de son rôle (c.-à-d. participant obligatoire vs admissible). Dans le cas où une mesure d’atténuation des risques s’avère nécessaire, le programme CFAPC est capable d’envoyer des messages bidirectionnels pour transmettre les RFI, RFS et DNL en temps quasi réel. Voir section [2.2.3 Messageries bidirectionnelles](#messages-bidirectionnels) pour plus de précisions.

## Inscription au CFAPC

Avant de présenter des données au CFAPC, les participants doivent s’adresser à Transports Canada pour une procédure unique d’inscription et d’agencement, laquelle consiste à identifier les personnes-ressources et à fournir les autorisations pour toute personne tierce qui doit présenter des données au CFAPC au nom du transporteur aérien, le cas échéant.
...
**Remarque :** Il est vivement conseillé aux transporteurs aériens de mener à bien ce processus plusieurs mois avant le début prévu des vols de transport de fret à destination du Canada..
...
<td><p>Le code à trois chiffres de l’IATA du transporteur aérien qui transporte le cargo à destination du Canada.</p>
...
<td><p>Code à sept chiffres qui identifie la partie responsable de la réception et de la réponse aux avis d’atténuation des risques, si différent du transporteur aérien.</p>
...
Après suffisamment d’essais dans l’environnement d’essai du CFAPC et l’approbation d’un représentant du CFAPC de Transports Canada, les participants ayant obtenu accès à l’environnement de production du CFAPC. Les transporteurs aériens doivent être entièrement opérationnels dans l’environnement de production avant la date d’entrée en vigueur de leurs opérations au Canada..
...
Les transporteurs aériens ayant planifié une période de non-disponibilité des systèmes doit informer Transports Canada à l’adresse PACT-Information-CFAPC@tc.gc.ca au moins trois (3) jours ouvrables avant l’interruption planifiée et inclure les informations suivantes :

- La date et la durée estimée de l’interruption;

- Les fonctions touchées (p. ex. : les éléments de données requis seront-ils toujours transmis pendant l’interruption? La messagerie bidirectionnelle (si elle est activée) continuera-t-elle de fonctionner, c’est-à-dire que le système recevra-t-il les messages « évaluation terminée » et RFI/RFS/DNL?)

L’équipe du CFAPC fournira ensuite des instructions au cas par cas dans ces circonstances.
...
<figcaption><p>Image  : Réponse d’erreur CAMIR</p></figcaption>
</figure>
...
<img src="images/media/image26.png" style="width:10.37819in;height:4.53931in" alt="A diagram of a diagram AI-generated content may be incorrect." />
...
**Sujet: OUVERTURE DE LA DEMANDE DE CONTR**Ô**LE (RFS) CFAPC: Numéro de la lettre de transport aérien \<\<\<insérer le numéro de la lettre de transport aérien\>\>**
...
Transports Canada demande un contrôle supplémentaire concernant le fret identifié dans cette lettre de transport aérien (voir l'objet) conformément à l'article 742(1) du *Règlement canadien sur la sûreté aérienne, 2012* (RCSA).
...
Une fois le contrôle effectué, veuillez répondre à tous incluant les informations suivantes:

1)  les méthodes de contrôle utilisées;
...
**Objet: FERMETURE DE LA DEMANDE DE CONTRÔLE (RFS) CFAPC: Numéro de la lettre de transport aérien \<\<\<insérer le numéro de la lettre de transport aérien\>\>\>**
...
La demande de contrôle (RFS) est fermée.
...
De: [PACT-Information-CFAPC@tc.gc.ca](https://034gc.sharepoint.com/sites/TC-100-136/TC11/Guidance/Policy/BCP_BIA/PACT-Information-CFAPC@tc.gc.ca) \[<TC.PPP.TC@tc.gc.ca> (après les heures d’ouverture)\]
